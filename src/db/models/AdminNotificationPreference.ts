...
export type AdminNotificationPreferenceOptionalAttributes = "id" | "userID" | "minimumThreshold" | "frequency" | "accepted" | "status" | "personIdentifier"| "createTimestamp" | "modifyTimestamp";
